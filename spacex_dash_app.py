...
spacex_df = pd.read_csv("~/Documents/Coursera_Materials/Data_Sets/Capstone/spacex_launch_dash.csv")
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                html.P("Select a Launch Site Here"),
...
def get_scatter_chart(payload, entered_site):
    ...
    if (entered_site == 'ALL'):
        fig = px.scatter(filtered_df, x='Payload Mass (kg)',
            ...
            title='Payload Mass (kg) Success Rates')
        return fig
    else:
        fig = px.scatter(filtered_df[filtered_df['Launch Site'] == entered_site],
                        ...
                        y='class',
                        color='Booster Version Category',
                        title='Payload Mass (kg) Success Rates for ' + entered_site
                        )
        return fig
